...
// NOTE: The checkbox inputs and number (AKA Lenth) input will determine the values/arguments entered into this function
...
clipboardEl.addEventListener(`click`, () => {
    ...
    // Referencing the "navigator" object to copy the selected value to the clipboard on the devise the webpage is being viewed on
